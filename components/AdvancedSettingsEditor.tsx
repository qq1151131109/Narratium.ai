    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center overflow-hidden p-2 sm:p-4">
      ...
      >
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          ...
          <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-96 h-96 bg-gradient-to-br from-rose-500/5 to-transparent rounded-full blur-3xl"></div>
        </div>

        <div className="flex items-center justify-between p-2 sm:p-5 border-b border-neutral-700/50 relative">
          <div className="flex items-center space-x-2 sm:space-x-3">
            <div className="w-5 h-5 sm:w-8 sm:h-8 rounded-lg bg-gradient-to-br from-rose-500/20 to-blue-600/30 flex items-center justify-center border border-rose-500/30 shadow-lg shadow-rose-500/10">
            ...
            <h2 className={`text-sm sm:text-xl font-semibold ${serifFontClass} bg-clip-text text-transparent bg-gradient-to-r from-rose-500 via-purple-400 to-purple-200`}>
        ...
        <div className="flex flex-1 overflow-hidden">
            ...
            <div className="relative z-10 space-y-1 sm:space-y-2">
              <button
                className={`w-full text-left px-1.5 sm:px-3 py-1.5 sm:py-2.5 rounded-lg transition-all duration-200 ease-in-out text-[10px] sm:text-sm font-medium ${fontClass} ${
                  activeTab === "tagColors"
                    ? "bg-gradient-to-r from-slate-700/80 via-blue-800/60 to-slate-700/80 text-amber-200 shadow-sm border border-blue-600/30 hover:shadow-lg hover:shadow-rose-500/20"
          ...
          <div className="flex-1 overflow-y-auto p-2 sm:p-6 bg-neutral-900/30 fantasy-scrollbar relative">
            <div className="absolute inset-0 bg-gradient-to-br from-rose-500/5 to-transparent opacity-30"></div>
