      ...
      {options && options.length > 0 && (
        <div className="pl-6 mb-4">
          <motion.div
            ...
            className="bg-black/20 border border-blue-500/25 rounded-xl p-4 mb-3 backdrop-blur-sm"
          >
            <div className="flex items-center gap-2 mb-3">
              <div className="w-1 h-4 bg-gradient-to-b from-blue-400 to-blue-600 rounded-full"></div>
              <span className="text-xs text-blue-400/90 font-medium tracking-wide">参考选项</span>
            </div>
      ...
      >
        <div className="relative inline-flex items-center min-w-[280px] max-w-lg">
          ...
          <button
            ...
            className="absolute right-1.5 p-1.5 text-blue-400 rounded-full hover:bg-blue-500/15 disabled:text-[#7db3fd]/40 disabled:hover:bg-transparent transition-all duration-200"
          >
            {isLoading ? (
              <div className="w-4 h-4 border-2 border-[#7db3fd]/40 border-t-blue-400 rounded-full animate-spin" />
            ) : (
