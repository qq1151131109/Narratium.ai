    ...
    <div className={`p-2 sm:p-4 ${fontClass} relative`}>
      ...
      <div className="relative z-10">
        <div className="flex items-center space-x-2 sm:space-x-3 mb-4 sm:mb-6">
          <div className="w-6 h-6 sm:w-8 sm:h-8 rounded-lg bg-gradient-to-br from-blue-500/20 to-blue-600/30 flex items-center justify-center border border-blue-500/30 shadow-lg shadow-blue-500/10">
          ...
          <h3 className={`text-base sm:text-lg font-semibold ${serifFontClass} bg-clip-text text-transparent bg-gradient-to-r from-blue-500 via-sky-400 to-sky-200`}>
        ...
        <div className="flex flex-col sm:flex-row gap-2 mb-4 sm:mb-6">
          <div className="flex-1 relative group">
            ...
            <input
              ...
              className="relative z-10 w-full px-3 py-2 bg-gradient-to-br from-[#1a1816] via-[#252220] to-[#1a1816] text-[#eae6db] rounded-lg border border-[#334155]/60 focus:border-blue-500/60 focus:outline-none focus:ring-2 focus:ring-blue-500/20 transition-all duration-300 hover:border-[#334155] backdrop-blur-sm shadow-inner text-sm sm:text-base"
            />
          </div>
          <button
              ...
              <div className="relative z-10 flex items-center gap-2 sm:gap-3">
                <div className="flex gap-1.5 sm:gap-2">
                  {getPredefinedColors(symbol).map((predefinedColor: string) => (
                    <button
                      key={predefinedColor}
                      className="relative group/color w-5 h-5 sm:w-6 sm:h-6 rounded-full border border-white/20 hover:scale-110 transition-transform shadow-lg hover:shadow-blue-500/20"
                ...
                <div className="relative">
                  <div
                    className="relative group/color w-6 h-6 sm:w-8 sm:h-8 rounded cursor-pointer border border-white/20 hover:scale-110 transition-transform shadow-lg hover:shadow-blue-500/20"
