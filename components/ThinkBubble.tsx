    ...
    <div className="mb-3">
      ...
      >
        <svg
          ...
          className={`h-4 w-4 text-[#a18d6f] group-hover:text-[#7db3fd] transition-transform duration-300 ${
        ...
        <div className="flex items-center gap-2">
          ...
          <span className={`text-sm text-[#a18d6f] group-hover:text-[#7db3fd] ${fontClass}`}>
