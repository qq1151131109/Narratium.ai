      ...
      {isOpen && (
        <div className="fixed inset-0 z-[9999] flex items-center justify-center">
          ...
          >
            ...
            <button 
              onClick={onClose}
              className="absolute top-3 right-3 sm:top-4 sm:right-4 text-[#a18d6f] hover:text-[#5b9cfa] transition-colors z-20"
            >
            ...
            <div className="text-center mb-6">
              ...
              <h1 className={`text-xl sm:text-2xl font-bold text-[#5b9cfa] mb-2 ${serifFontClass}`}>
                {presetInfo.title}
              </h1>
                ...
                <ul className="space-y-2">
                  {presetInfo.features.map((feature, index) => (
                    <li key={index} className="flex items-start">
                      <div className="w-1.5 h-1.5 rounded-full bg-[#5b9cfa] mt-2 mr-3 flex-shrink-0"></div>
                      <span className={`text-xs sm:text-sm text-[#7db3fd] ${fontClass}`}>
                        {feature}
                      </span>
                    </li>
                  ))}
